            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <div class="space-y-2">
                  ...
                  <div v-if="candidate.linkedin_url" class="flex items-center justify-between py-2">
                    <span class="text-sm text-surface-600 dark:text-surface-400">LinkedIn</span>
                    <a
                      :href="candidate.linkedin_url"
                      target="_blank"
                      rel="noopener noreferrer"
                      class="text-sm font-medium text-brand-600 dark:text-brand-400 hover:underline inline-flex items-center gap-1"
                    >

      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="flex items-center gap-2 mt-1 text-[11px]" style="color: var(--tg-theme-hint-color);">
          <span v-if="vacancy.city || props.distance != null" class="flex items-center gap-0.5 truncate">
            ...
            {{ vacancy.district || vacancy.city }}<template v-if="props.distance != null"><span style="opacity:0.5"> · </span>{{ Math.round(props.distance * 10) / 10 }} km</template>
          </span>
...
import { formatSalary as _formatSalary, timeAgo as _timeAgo, getInitial } from '@/utils/formatters'

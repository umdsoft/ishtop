      ...
      <div class="px-5 pt-4 space-y-3">
        ...
        <div class="rounded-2xl p-4" style="background-color: var(--tg-theme-secondary-bg-color);">
          ...
          <div class="space-y-3">
            ...
            <InfoRow :label="t('candidate.city')" :value="formatLocation(profile.city, profile.district)" />
...
import { formatNumber, getInitial as _getInitial, formatLocation } from '@/utils/formatters'
